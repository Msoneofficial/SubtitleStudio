...
class VideoRepository {
  ...
  Future<String?> getSavedVideoPath(int collectionId) async {
    ...
    try {
      if (Platform.isMacOS) {
        final videoPrefs = await PreferencesModel.getVideoPreferences(collectionId);
    ...
    try {
      if (Platform.isMacOS) {
        ...
        if (bookmark != null) {
          ...
          await PreferencesModel.saveVideoPath(collectionId, path, macOsBookmark: bookmarkString);
